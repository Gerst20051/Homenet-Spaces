...
if (empty($email)) {
$header_resetpassworderrors[] = 'Email Address cannot be blank.';
}

if (isset($_SESSION['logged'])) {
$header_resetpassworderrors[] = 'You cannot be logged in while you reset your password.';
}
...
} else { // no errors so get the data from the database
$query = 'SELECT user_id, firstname, middlename, lastname, email, security_question1, security_answer1, security_question2, security_answer2
FROM
info
WHERE ' .
...
if ($usersecurity_question1 == $usersecurity_question2) {
$header_resetpassworderrors[] = 'User Security Questions cannot be the same.';
}

if (($usersecurity_question1 == null) || ($usersecurity_answer1 == null) || ($usersecurity_question2 == null) || ($usersecurity_answer2 == null)) {
if (empty($usersecurity_question1)) {
$header_resetpassworderrors[] = 'User Security Question 1 cannot be blank.';
}

if (empty($usersecurity_answer1)) {
$header_resetpassworderrors[] = 'User Security Answer 1 cannot be blank.';
}

if (empty($usersecurity_question2)) {
$header_resetpassworderrors[] = 'User Security Question 2 cannot be blank.';
}

if (empty($usersecurity_answer2)) {
$header_resetpassworderrors[] = 'User Security Answer 2 cannot be blank.';
}

if (empty($usersecurity_answer1) || empty($usersecurity_answer2)) {
$footer_error = '<p><strong style="color : #ff3333; weight : bold; ">Unable to reset your password.</strong></p>';
}
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//<?php echo $TEXT['global-dtdlang']; ?>" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $TEXT['global-lang']; ?>" lang="<?php echo $TEXT['global-lang']; ?>" dir="<?php echo $TEXT['global-text_dir']; ?>">
...
if (empty($members_id)) {
$header_resetpassworderrors[] = 'Members ID cannot be blank.';
}
...
$header_resetpassworderrors[] = 'Security Answer 1 cannot be blank.';
}

if (empty($security_answer2)) {
$header_resetpassworderrors[] = 'Security Answer 2 cannot be blank.';
}
...
password = PASSWORD("' . mysql_real_escape_string($new_password, $db) . '")
WHERE
user_id = ' . $members_id . '
LIMIT 1';
