...
class securityimage {
	...
	function selectfont() {
		switch (mt_rand(1,5)) {
			case 1: $font = "acidic.ttf"; break;
			case 2: $font = "arial.ttf"; break;
			case 3: $font = "frizzed.ttf"; break;
			case 4: $font = "layne_moonflower.ttf"; break;
			case 5: $font = "layne_thornpatch.ttf"; break;
		}
		$this -> font = "i/captcha/fonts/" . $font;
	}
}
