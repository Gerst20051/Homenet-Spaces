...
echo '<span style="margin : 15px; text-align : center; width : 150px; "><a href="user_profile.php?id=' . $users_id . '"><img src="uploads/' . $users . '/images/thumb/' . $default_image . '" id="defaultuserimage" alt="View ' . $first_name . ' ' . $last_name . '\'s Profile!" /></a></span>';
} else {
echo '<span style="margin : 15px; text-align : center; width : 150px; "><a href="user_profile.php?id=' . $users_id . '" title="View ' . $users . '\'s Profile!"><img src="i/mem/default.jpg" id="defaultuserimage" /></a></span>';
}
}
}
