...
if (!is_dir($filesdir)) {
mkdir($filesdir, 0777, true) or die("Directory could not be created.");
}
...
if (isset($_GET['id'])) {
echo "<h1>View " . $user . "'s Files!</h1>";
} else {
echo "<h1>View shared Files!</h1>";
}
...
if ($filetype == "css") {
echo "<img src='i/sy/i/file/css.gif' title='css' />";
} elseif ($filetype == "dm") {
echo "<img src='i/sy/i/file/dreamweaver.gif' title='dreamweaver' />";
} elseif (($filetype == "xls") || ($filetype == "xlsx")) {
echo "<img src='i/sy/i/file/excel.gif' title='spreadsheet' />";
} elseif ($filetype == "exe") {
echo "<img src='i/sy/i/file/exe.gif' title='exe' />";
} elseif ($filetype == "fla") {
echo "<img src='i/sy/i/file/flash.gif' title='flash' />";
} elseif (($filetype == "htm") || ($filetype == "html")) {
echo "<img src='i/sy/i/file/html.gif' title='htm / html' />";
} elseif ($filetype == "ill") {
echo "<img src='i/sy/i/file/illustrator.gif' title='illustrator' />";
} elseif ($filetype == "ind") {
echo "<img src='i/sy/i/file/indesign.gif' title='indesign' />";
} elseif ($filetype == "mp3") {
echo "<img src='i/sy/i/file/mp3-music.gif' title='mp3' />";
} elseif (($filetype == "doc") || ($filetype == "docx")) {
echo "<img src='i/sy/i/file/ms-word.gif' title='word' />";
} elseif ($filetype == "pdf") {
echo "<img src='i/sy/i/file/pdf.gif' title='pdf' />";
} elseif ($filetype == "php") {
echo "<img src='i/sy/i/file/php.gif' title='php' />";
} elseif ($filetype == "phshop") {
echo "<img src='i/sy/i/file/photoshop.gif' title='photoshop' />";
} elseif ($filetype == "ppt") {
echo "<img src='i/sy/i/file/ppt.jpeg' title='powerpoint' />";
} elseif ($filetype == "qt") {
echo "<img src='i/sy/i/file/quicktime-movie.gif' title='quicktime' />";
} elseif ($filetype == "text") {
echo "<img src='i/sy/i/file/text.gif' title='text' />";
} elseif ($filetype == "txt") {
echo "<img src='i/sy/i/file/txt.gif' title='txt' />";
} elseif (($filetype == "wma") || ($filetype == "wmv")) {
echo "<img src='i/sy/i/file/window-media.gif' title='windows media' />";
} elseif ($filetype == "xml") {
echo "<img src='i/sy/i/file/rss.gif' title='xml' />";
} elseif ($filetype == "zip") {
echo "<img src='i/sy/i/file/zip.gif' title='zip' />";
} else {
echo "<img src='i/sy/i/file/file.gif' title='file' />";
}
